...
$output = NULL;
	...
	$fdata = $conn->query("SELECT * FROM games WHERE GameTitle = '$game'");
	$data = $fdata->fetch_assoc();
	
	echo "<h1>" . $data['GameTitle'] . "</h1></br>";
 	if($data['Youtube'] != NULL){
		?>
         <iframe width="560" height="315" src="<?php echo $data['Youtube']; ?>" frameborder=0 allowfullscreen> 
		</iframe>
        <?php
	} 
	
	?>
	<p style="font-size:20px" align="left">Developer : <?php echo $data['Developer']; ?></p>
	<p style="font-size:20px" align="left">Publisher : <?php echo $data['Publisher']; ?></p>
	<p style="font-size:20px" align="left">Release Date : <?php echo $data['ReleaseDate']; ?></p>
    <p style="font-size:20px" align="left">Metacritic : <?php echo $data['Metacritic']; ?></p>
	<p align="left"><?php echo $data['Overview']; ?></p>
    <p style="font-size:20px" align="left"><a href="<?php echo $data['Store']; ?>" style="text-decoration:none; color:#CCC;">Buy This Game</p>
	<?php
?>
</div>
